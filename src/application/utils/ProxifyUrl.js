...
//image proxy url = https://steemitdevimages.com/
...
export const imageProxy = () => 'https://steemitdevimages.com/';
...
export default (url, dimensions = false) => {
    ...
    if (dimensions && 'https://steemitdevimages.com/') {
        let dims = dimensions + '/';
        ...
        if (
            ...
            return 'https://steemitdevimages.com/' + dims + respUrl;
        }
    }
    return respUrl;
};
