...
import Link from '@utils/SlateEditor/Link';
import Image from '@utils/SlateEditor/Image';
import Iframe from '@utils/SlateEditor/Iframe';
import HRule from '@utils/SlateEditor/HRule';
import Align from '@utils/SlateEditor/Align';
