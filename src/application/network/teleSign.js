...
import env from '@eenv/env.json';
import crypto from 'crypto';
import secureRandom from 'secure-random';

const customer_id = env.telesign.customer_id;

let api_key = '';

if (env.telesign.rest_api_key) {
    api_key = new Buffer(env.telesign.rest_api_key, 'base64');
}
