...
import { sendDeletePasswordConfirmationMailRoute } from '@infrastructure/RouteInitialize';

class SendDeletePasswordConfirmationMailModal extends React.Component {
    static propTypes = {
    ...
    static pushURLState(title) {
        if (window)
            window.history.pushState(
                {},
                title,
                sendDeletePasswordConfirmationMailRoute.path
            );
    }
    ...
    componentDidMount() {
        SendDeletePasswordConfirmationMailModal.pushURLState(tt('g.signup'));
    }
            ...
            <div className="login-modal">
                ...
                <div className="login-modal-items">
                    <LoginModalList
                        ...
                        confirmationDeletePassword={true}
                    />
                </div>
            </div>
        );
