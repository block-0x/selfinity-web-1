...
import Navigation from '@modules/Calendar/Calendar/Navigation';
...
import {
    ...
    callIfDefined,
    mergeFunctions,
} from '@modules/Calendar/shared/utils';
...
export default class Calendar extends Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if (
            datesAreDifferent(
                nextActiveStartDate,
                prevState.activeStartDateProps
            )
        ) {
